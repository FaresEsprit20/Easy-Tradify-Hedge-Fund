...
import com.trading.easytradify.portfolio.PortfolioRiskManagementApplication;
...
@SpringBootTest(
        classes = PortfolioRiskManagementApplication.class,
        webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT
)
public abstract class BasePortfolioRiskIntegrationTest {
    ...
    protected String portfolioBaseUrl;

    @BeforeEach
    void setUpBase() {
        baseUrl = "http://localhost:" + port;
        apiKey = "easy-tradify-internal-secret-key-2026";
        portfolioBaseUrl = baseUrl + "/api/v1/portfolio";
